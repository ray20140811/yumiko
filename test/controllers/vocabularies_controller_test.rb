...
class VocabulariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vocabulary" do
    assert_difference("Vocabulary.count") do
      post vocabularies_url, params: { vocabulary: { chinese: @vocabulary.chinese, english: @vocabulary.english, japanese: @vocabulary.japanese, kanji: @vocabulary.kanji } }
    end
  ...
  test "should update vocabulary" do
    patch vocabulary_url(@vocabulary), params: { vocabulary: { chinese: @vocabulary.chinese, english: @vocabulary.english, japanese: @vocabulary.japanese, kanji: @vocabulary.kanji } }
